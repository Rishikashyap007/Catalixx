...
//   return (
//     <>
//       <div className="container flex w-full gap-4 px-4 h-screen items-center bg-slate-100 ">
//         <div className="sidebar w-[20%] h-[95%] py-3 px-4 bg-slate-600 rounded-lg flex flex-col justify-evenly items-right">
...
//             <div className="flex gap-4 text-white items-center  px-4 py-2 rounded-lg ">
//               <span class="material-symbols-outlined">home</span>
//               <p className="text-2xl font-medium"> transformation </p>
//             </div>
//             <div className="flex gap-4 text-white items-center  px-4 py-2 rounded-lg">
//               <span class="material-symbols-outlined">home</span>
//               <p className="text-2xl font-medium"> Library </p>
//             </div>
//           </nav>

//           <div className="footer w-full p-4 border-t-4 border-white-500 rounded-sm">
...
//           </div>
//         </div>
//         <div className="middlepart w-[50%] h-[95%] bg-slate-100  rounded-lg flex flex-col items-center gap-8">
//           <div className="search-bar w-[70%] flex justify-between items-center p-2 rounded-lg border-2 border-gray-300">
...
//             </p>
//           </div>
//           <div className="card flex flex-col justify-around items-center border-2 border-gray-200 rounded-lg bg-slate-50 h-80 shadow-2xl py-8">
//             <button className="bg-slate-400 text-xl text-white px-6 py-2 rounded-full">
//               {" "}
//               2/6{" "}
//             </button>
...
//           </div>
//         </div>
//         <div className="lastpart w-[35%] h-[95%] rounded-lg flex flex-col items-end">
//           <div className="flex gap-4 ">
//             <span class="material-symbols-outlined bg-slate-200 p-2 rounded-full">add_alert</span>
//             <span class="material-symbols-outlined bg-slate-200 p-2 rounded-full">comment</span>
//           </div>
